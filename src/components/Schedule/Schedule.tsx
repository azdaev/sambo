    ...
    <ScheduleContainer id="schedule">
      <ScheduleContent>
        ...
        <ScheduleGrid>
          ...
          <AgeGroupCard>
            ...
            <ScheduleList>
              <li>
                <span className="day">Понедельник</span>
                <span className="time">20:00 - 21:30</span>
              </li>
              <li>
                <span className="day">Среда</span>
                <span className="time">20:00 - 21:30</span>
        ...
        <ImportantNote>
          ...
          <p>
            Не откладывайте! Места в группах ограничены. Приходите на пробную тренировку и убедитесь в качестве нашего
            обучения.
          </p>
          <p className="schedule-note">
            ⚠️ <strong>Важно:</strong> Время тренировок может измениться. Пожалуйста, уточняйте актуальное расписание
            перед приходом на тренировку.
          </p>
        </ImportantNote>
      </ScheduleContent>
    </ScheduleContainer>
